class Ledger {
    ...
    async getAll(args= {})  {
        return await this.qldbConnection.findBy(this.tableName,{where:args});
    };

    async getBy(args)  {
        return await this.qldbConnection.findBy(this.tableName,args);
    };
    ...
    async getByPk(value)  {
        ...
        return await this.qldbConnection.findOneBy(this.tableName,{where:args});
    };
