...
class qldbConnect {
    ...
    constructor(ledgerName, serviceConfigOptions) {
        const { retryLimit, poolLimit, timeoutMillis, ...qldbClientOptions } = serviceConfigOptions
        this.qldbDriver = new QldbDriver(ledgerName, qldbClientOptions, retryLimit, poolLimit, timeoutMillis);
